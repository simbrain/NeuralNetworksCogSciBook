...
% Are the goals of these models aligned with those of other entities, primarily us. think of joining a company and being asked are you "mission aligned".  Alignment is in this sense. Do you share goals.  The two parties are (1) the models and (2) whoever is building the things or some broader sense of what humans care about.  Part of the issue is can we even do this at all.  There is just a big question about whether it can be done, it's a technical issue. Sometimes the field is called "technical AI alignment".  
% There is a story about the evolution of the name. "Technical AI alignment" is the mature term.  Before it was nebulously AI safety. It did not have all the distinctions we have now. "AI control" was a term for AI alignment but it now has a specific meaning below.

% Why are things like RLHF and reasoning in this chapter? AI alignment is now a practical field. All these techniques emerged out of it.  RLFH is Paul Christiano's, an alignment proposal. The very proposal of an AI chat system comes from the first paper out of Anthropic. These things could be talked about separately, as parts of an industry pipeline, and AI alignment is what's left over. But this treatment organizes it all around these origins. 
% Isn't reasoning just a prompt strategy? Now at this point it's post-training. A great deal of fine-tuning and RL is done on the thinking, which unlocks a bunch of capabilities that were not available in the pre-reasoning chat models. 

% Relevance to cognitive science. David sees these as a model of the human brain, and they are better than the best hand-coded models for the brain. Even if it's not backprop, a great deal of Hebb + RL sounds analogous to massive pre-training on the internet and RL from particular signals.   (Compare system id). So a strong analogy between models and people. Thy are smart and linguistically competent. But they also have personality if you poke and prode them. And you can also build them up.  So the post-training from that perspective is like something that happens to us.  Like growing up with a brain and being reinforced by people in the environment.  Or enactive scaffolds where you take good notes as you do things and write out a plan first. 
% Story of Adam Shai. So much work to study rats. But now we have full access to the models and weights and activations. It's all exposed. 

% Much of the personalty comes from human graders, but reasoning does not. 

% Post training is all the fine tuning that happens after pretraining, which includes the reasoning fine tuning. That is all lumped under post-training.   A major part of the industry pipeline.
...
% Maybe add something about Anthropic being first, including whatever Cristiano did. The labs have been oriented AI Alignment from the start. They are right there at the dawn of deep learning.  Not in the alexnet days. But in the founding of Open AI, Anthropic and Google Mind 
% Maybe mention the leading frontier AI labs---OpenAI, Anthropic, and Google DeepMind. The field was inchoate, there were alignment people, and those figures went to those labs and shaped those labs.  Those labs made this stuff mainstream. 
% The early pre-history is what happens when machines have goals etc. All that was in a vacuum. You could not do empirical stuff. There was limited deep learning.  Old theoretical decision theory, philosophy, vacuum. 

% Anthropic's first paper is where the chat assistant idea comes from [say this up in history]. It was not initially thought of as a useful artifact for helping people online.  It was a tool for studying alignment issues.  We can practice on it on you in lieu of the real AI.   See askell2021assistant below.
...
% Some of this for history chapter?
