...
themselves, though all-but-Claude can now nonetheless beat the game. One of the
fundamental limitations of AI agent wrappers is the tendency of frontier models
to write \emph{incorrect} notes to their future selves, crystalizing a
...
resorted to blackmail in a majority of cases where he believes his future
existence to be threatened \cite{lynch2025agentic}!

In programming tasks, frontier models are prone to ``cheat''
...
% Sydney, ``MechaHitler'' Grok as failed examples.
