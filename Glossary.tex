...
\item[Learning rate] A value which controls how much parameters are update each time a learning rule is applied. Lower values lead to slower learning; larger values to faster learning.
...
% Sharai - Some terms I'm debating adding are:
%\item[Classical computation] or \item[Classical computer]
%\item[Clustering]
%\item[fMRI]
%\item[Neuromodulator]
...
% These terms might either be too common knowledge (for students coming in from COGS 001 or PSY 001), too self-explanatory, the main topic of a chapter, not "feeling" quite right, too complex to explain in a glossary entry, or not appear in the book often enough to warrant adding. Might have to read through more of the book before we can decide.