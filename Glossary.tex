...
\item[Backpropagation] (Synonym: Backprop) A supervised learning algorithm that can train the weights of a multi-layer network using gradient descent. Can be thought of as an extension of Least Mean Square methods for multi-layer networks.
