...
In this table, there are two ways of thinking geometrically about its entries. From one perspective, ordered pairs of heights and weights in the five rows of the table are coordinates of five points in $\real^2$.
...
points in $\real^5$.  Since this space has 5 dimensions we cannot visualize
...
\end{equation*}
For the purpose of visualizing the geometrical relationship between
...
\end{equation*}
so that $\{ \mathbf{h}, \mathbf{u} \}$ is a nearly orthogonal basis for the span
...
individuals in the table.  The odd numbered points are again nearly collinear to
