...
\begin{figure}[h]
\centering
\accessibleimage[scale=.6]{./images/decisionBoundary.png}{Two-dimensional classification task with six input points labeled by bipolar target values. A straight decision boundary with slope minus one and intercept one separates the two classes.}
...
\begin{figure}[h]
\centering
\accessibleimage[scale=1.0]{./images/decisionLinePlanes.png}{Decision boundary as the intersection of two surfaces. Red regions indicate positive net input and blue regions negative net input; their intersection is the classification boundary.}
