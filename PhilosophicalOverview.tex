...
So where do LLMs stand? They seem clearly to be systematic, productive, and compositional. They can say things in multiple ways, they can produce indefinitely many statements, they are aware of how the ``Lego blocks'' of language fit together and how the meanings of the whole derive from the meaning of the parts. They can handle any test comprehension sentence or linguisstic aptitude test that Fodor and Pylyshyn ever came up. 
