...
\end{quote}
Most people can't tell that this was written by a computer.  

Of course, as noted above, the idea of training recurrent networks to be language models has been supplanted by training transformer networks to be large language models, and so these ideas are familiar. Moreover, it's no longer just fake news and math, but real summaries which are often accurate. These developments are discussed in chapter \extref{ch_transformers}. 
