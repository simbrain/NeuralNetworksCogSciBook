...
% TODOS
% 
% Add 3b1b note. As usual, the GOAT...
%
% Different types of llm like Claude and Bard. Build this off the hyperparameter discussion. Ex: Claude has a large context window.  
...
% Tim's email
%
%fine tuning is updating an already existing LLM to bias it in favor of the language in some specified corpus you are interested in. For example you might download a llama 2 model, and then fine tune it based on a set of corpus using x library.
...
%
%* policy gradient
%* added external functionalities like wolfram alpha
%
%*prompt engineering
%* prompt templates
%* prompting techniques
%* funny historical examples of prompting discoveries
%
