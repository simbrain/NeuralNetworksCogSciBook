...
% This big pass is coming esp. here. One thing to do is to show the embedded tokens stacked in matrix form. This can also be cohered with the NLP chapter.
...
% Forward ref here to the mcclelland Bert paper.
...
% Tim:  think this would be really nice to have this as a system diagram or like the multi head diagram above.
...
\section{Relevance to cognitive sciences}\label{llm_cogsci}
...
There are papers that show that LLM representations are aligned with (i) neural activation, (ii) perceptual spaces, (iii) physical spaces and (iv) conceptual spaces.
This is  all nicely discussed in "Søgaard, A. (2023). Grounding the vector space of an octopus: Word meaning from raw text. Minds and Machines, 33(1), 33-54."

\subsection{LLMs and Linguistics}

An early transformer-based LLM was BERT.  Linguists and cognitive scientists immediately took note of systems like this given their ability to handle long-range dependencies in texts. In  a paper co-authored by Jay McClelland  \cite{mcclelland2020placing} (a member of the original PDP group at UCSD; see section \extref{first_resurgence}), the following example is used to illustrate the point:
\begin{quote}
...
The Chinese Room contains empty symbols but in LLMS they have meaningful representational properties. 



% Discussion of LLMs being human built but of interest to science.
...
% 
%This is a twist on our earlier discussion of types of neural network research (section \extref{typesOfResearch}). It was built for engineering, but ended up being useful for science. Most earler cases started in science and went to engineering (e.g. deep learning CNNs).
%
