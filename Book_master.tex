...
\author{Jeff Yoshimi, Zo\"e Tosi, Scott Hotton, Chelsea Gordon, Dave Noelle}
\date{Version 2023.1.1}  % Year based semantic-versioning. Year.Major.Minor
\maketitle
...
\input{ActivationFunctionExercises}
\input{LinearAlgebra}
\input{LinearAlgebraExercises}
