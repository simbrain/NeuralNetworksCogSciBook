...
\stepcounter{CNNCounter}
\noindent
{\bf \theCNNCounter}. Apply the corner/L-shape detector filter $\begin{pmatrix} 1 & 0 \\ 1 & 1 \end{pmatrix}$ to the binary input matrix $\begin{pmatrix} 1 & 0 & 0 \\ 1 & 1 & 0 \\ 0 & 0 & 0 \end{pmatrix}$ with stride 1. What is the output matrix? {\bf Answer:} $\begin{pmatrix} 3 & 0 \\ 2 & 0 \end{pmatrix}$. 
