...
they are processed along a residual stream (on the concept of a residual stream see section \extref{transformerBlocks}).\footnote{The use of
...
attention mechanism in transformer blocks (whose activations can be read as ``scores''; see section \extref{transformerBlocks}) lends itself to interpretation
without having to graf on of any additional structure--just as the output
