...
see section \extref{transformerBlocks}).\footnote{The use of these terms raise
...
A second hypothesis about how learned programs work is that it is
...
interpretation without having to graf on of any additional structure--just as
