...
This book uses custom scripts and \LaTeX commands that allow it to be used in a modular way. The most complete version of the book (the ``master document'') is hosted on a github repository.\footnote{\url{https://github.com/simbrain/NeuralNetworksCogSciBook}} Those chapters can be combined and remixed in your own ``container'' documents that only contain the information you need for a particular use (\eg for a particular class you are teaching). You can fork the repository and  create your own container documents containing whichever chapters you like, including new material of your own, or adaptations of existing chapters. Guidelines for assembling your own container documents, and for producing new chapters of your own (which we hope you will share with us!), are in the readme document in the repository for this page.
