...
\begin{figure}[h]
\centering
\accessibleimage[width=\textwidth]{./images/SR_VoltTraces.png}{Four Simbrain examples of postsynaptic response mechanisms. Each row pairs a red synaptic-response trace with a blue integrate-and-fire membrane-potential trace: step function, instantaneous jump and decay, convolutional jump and decay, and rise and decay.}
...
\begin{figure} [h]
\centering
\accessibleimage[width=\textwidth]{./images/STDP_intro_fig.png}{Spike-timing-dependent plasticity diagram and data. When a presynaptic spike precedes a postsynaptic spike, the synapse strengthens; reversing the order weakens it. A scatterplot shows the change in EPSC amplitude versus spike-timing difference.}
